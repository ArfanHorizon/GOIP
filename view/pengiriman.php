              ...
              <form action="#" method="post">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title" id="myModalLabel">
                    <center>Tambah Data Pengiriman</center>
                  </h4>
                </div>
                  ...
                  <div class="box-body">
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <div class="form-group">
                          <label>Alamat</label>
                          <textarea type="textarea" class="form-control" id="alamat" name="alamat" required></textarea>
                        </div>
            ...
            <form action="#" method="post" id="updateFormPengiriman">
              <div class="modal-header">
                <h4 class="modal-title" id="exampleModalLabel">
                  <center>Edit Data Pengiriman</center>
                </h4>
          ...
          <div class="modal-content">
            <form action="#" method="post" id="delFormPengiriman">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title" id="myModalLabel">
                  <center>Delete Pengiriman</center>
                </h4>
              </div>
